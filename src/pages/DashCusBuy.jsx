...
import TotalSales from "@/components/dashboardSales/TotalSales";
import { getCusBuy } from "@/api/dashCusBuy";
import TotalCusBuy from "@/components/DashCusBuy/TotalCusBuy";
import TotalMemberOrders from "@/components/DashCusBuy/TotalMemberOrders";
import TotalMemberSales from "@/components/DashCusBuy/TotalMemberSales";
import TotalNonMemberOrders from "@/components/DashCusBuy/TotalNonMemberOrders";
import TotalNonMemberSales from "@/components/DashCusBuy/TotalNonMemberSales";
import ChartDonutCusBuy from "@/components/DashCusBuy/ChartDonutCusBuy";
import SumOrders from "@/components/DashCusBuy/SumOrders";
import PurchaseList from "@/components/DashCusBuy/PurchaseList";
...
const DashCusBuy = () => {
  ...
  const [cusBuy, setCusBuy] = useState({});
  ...
  useEffect(() => {
    ...
    getCusBuy(token, startDate, endDate)
      .then((res) => {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-4 gap-3 auto-rows-max">
        <div>
          <TotalCusBuy data={cusBuy.sumOrders} />
        </div>
        <div>
          <TotalMemberSales data={cusBuy.totalMemberSales} />
        </div>
        <div>
          <TotalNonMemberSales data={cusBuy.totalNonMemberSales} />
        </div>
        <div className="col-span-1 row-span-2">
          <ChartDonutCusBuy
            totalNonMemberSales={cusBuy.totalNonMemberSales}
            totalMemberSales={cusBuy.totalMemberSales}
          />
        </div>
        <div>
          <SumOrders
            data={cusBuy.totalMemberOrders + cusBuy.totalNonMemberOrders || 0}
          />
        </div>
        <div>
          <TotalMemberOrders data={cusBuy.totalMemberOrders} />
        </div>
        <div>
          <TotalNonMemberOrders data={cusBuy.totalNonMemberOrders} />
        </div>
